"""
Django settings for ecomb project.
...
SECRET_KEY = 'django-insecure-e(dc!=!5mpe9#a5b+7%et_4p=_lma5f&4kc79rdzdyur1d6ub&'
...
MIDDLEWARE = [
    ...
    # Django session and CSRF
    "django.contrib.sessions.middleware.SessionMiddleware",
    "django.middleware.common.CommonMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",

    # CORS (must be placed above AuthenticationMiddleware if used)
